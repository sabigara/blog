---
title: "How to embed live previews of React components in MDX docs"
date: "2022-12-06"
tags: ["react", "mdx"]
draft: false
---
...
I'd like to share how to embed interactive previews for React component documentation page like [Chakra UI's docs site](https://chakra-ui.com/docs/components/button). _Interactive_ means that you can click the rendered button and the code is editable: if you change the inner text of the button, the preview reflects the change.
